-- ============================================
-- COMPLETE FIX FOR INFINITE RECURSION ERROR
-- Run this entire script in Supabase SQL Editor
-- ============================================

-- STEP 1: Remove problematic policies causing infinite recursion
...
-- STEP 3: Create secure admin functions that bypass RLS
...
-- VERIFICATION
-- ============================================
-- Check that the problematic policies are gone
