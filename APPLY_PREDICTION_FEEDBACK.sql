-- ============================================================
-- DISEASE PREDICTIONS & DOCTOR FEEDBACK SYSTEM
-- Run this SQL in your Supabase SQL Editor to enable the feature
-- ============================================================
...
DROP POLICY IF EXISTS "Doctors can view all predictions" ON disease_predictions;
DROP POLICY IF EXISTS "Doctors can review predictions" ON disease_predictions;
DROP POLICY IF EXISTS "Admins have full access to predictions" ON disease_predictions;
...
DROP TRIGGER IF EXISTS trigger_disease_predictions_updated_at ON disease_predictions;
...
-- ============================================================
-- SUCCESS! The disease prediction feedback system is now set up.
-- 
-- Features enabled:
-- 1. Predictions are auto-saved when users use the symptom checker
-- 2. Doctors can review predictions in the "AI Review" tab
-- 3. Admins can see model feedback statistics in "Model Feedback" tab
-- ============================================================
