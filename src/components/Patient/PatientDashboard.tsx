              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 p-4 rounded-lg hover:bg-gray-50 transition-colors border border-gray-200 text-left group"
                  >
                    <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      <FileText className="w-5 h-5 text-teal-600" />
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">Medications Guide</p>
                      <p className="text-xs text-gray-500">Drug information</p>
                    </div>
                  </button>
                </div>
              </div>
